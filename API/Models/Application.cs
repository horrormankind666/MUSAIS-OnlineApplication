...
namespace API.Models
{
    public class Application
    {
        ...
        public string studentCategorySpecify { get; set; }
	    public string studentCategoryOther { get; set; }
        public string countryId { get; set; }
        public string universityId { get; set; }
        public string universityOther { get; set; }
        public string facultyId { get; set; }
        public string department { get; set; }
        public string semesterDateStart { get; set; }
        public string semesterDateEnd { get; set; }
        public string homeAddress { get; set; }
        public string homeDistrict { get; set; }
        public string homeCity { get; set; }
        public string homeProvince { get; set; }
        public string homePostalCode { get; set; }
        public string countryHomeId { get; set; }
        public string mailingAddress { get; set; }
        public string mailingDistrict { get; set; }
        public string mailingCity { get; set; }
        public string mailingProvince { get; set; }
        public string mailingPostalCode { get; set; }
        public string countryMailingId { get; set; }
        ...
        public string emergencyMailingAddress { get; set; }
        public string emergencyMailingDistrict { get; set; }
        public string emergencyMailingCity { get; set; }
        public string emergencyMailingProvince { get; set; }
        public string emergencyMailingPostalCode { get; set; }
        public string countryMailingEmergencyId { get; set; }
        public string emergencyHomeTel { get; set; }
        public string emergencyOfficeTel { get; set; }
        public string emergencyMobile { get; set; }
        public string emergencyFax { get; set; }
        public string emergencyEmail { get; set; }
        public string curEduInstitution { get; set; }
        public string curEduFaculty { get; set; }
        public string disciplineId { get; set; }
        public string educationalBackgroundId { get; set; }
        public string curEduYear { get; set; }
        public string TOEFLScore { get; set; }
        public string TOEFLTypeId { get; set; }
        public string IELTSResult { get; set; }
        public string englishNativeOther { get; set; }
        public string passportFile { get; set; }
        public string facePhotographsFile { get; set; }
        public string transcriptFile { get; set; }
        public string travelInsuranceFile { get; set; }
        public string letterHomeUniversityFile { get; set; }
        public string curriculumVitaeFile { get; set; }
        public string TOEFLIELTSFile { get; set; }
        public string letterIntentFile { get; set; }
        public string declarationA { get; set; }
        public string declarationB { get; set; }
        public string declarationC { get; set; }
        public string declarationD { get; set; }
        public string declarationE { get; set; }
        public string declarationESpecify { get; set; }
        public string submitStatus { get; set; }
        public string submitBy { get; set; }
        public string submitIp { get; set; }
        public string applicationStatus { get; set; }
        public string centralApprovalStatus { get; set; }
        public string centralApprovalBy { get; set; }
        public string centralApprovalIp { get; set; }
        public string divisionApprovalStatus { get; set; }
        public string divisionApprovalBy { get; set; }
        public string divisionApprovalIp { get; set; }
