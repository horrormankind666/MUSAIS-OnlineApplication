...
(function () {
  ...
  .service("academicInfoServ", function ($timeout, utilServ, dictServ, pageRouteServ) {
		var self = this;
  ...
  .controller("application.academicInfoCtrl", function ($scope, $timeout, $q, utilServ, appServ, dictServ, pageRouteServ, academicInfoServ) {
		var self = this;
