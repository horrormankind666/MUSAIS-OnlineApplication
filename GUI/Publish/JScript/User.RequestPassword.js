...
(function () {
    ...
    .controller("user.requestPasswordCtrl", function ($scope, $timeout, $q, utilServ, appServ, dictServ) {
        var self = this;
        ...
        self.sendEmail = {
            validate: function () {
                ...
                if (!self.formField.verifyCode) { self.formValidate.isValid.verifyCode = false; i++; }
