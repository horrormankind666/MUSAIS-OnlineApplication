...
(function () {
    ...
    .controller("application.academicInfo.curEduCtrl", function ($scope, $timeout, $q, utilServ, appServ, applicationServ, academicInfoServ, disciplineServ, educationalBackgroundServ, yearStudyServ) {
        var self = this;
        ...
        self.saveChange = {
            validate: function () {
                ...
                if (!self.formField.eduInstitution) { self.formValidate.isValid.eduInstitution = false; i++; }
                if (!self.formField.eduFaculty) { self.formValidate.isValid.eduFaculty = false; i++; }
                if (!self.formField.disciplineSelected.selected) { self.formValidate.isValid.discipline = false; i++; }
                if (!self.formField.educationalBackgroundSelected.selected) { self.formValidate.isValid.educationalBackground = false; i++; }
                if (!self.formField.yearStudySelected.selected) { self.formValidate.isValid.yearStudy = false; i++; }
