...
(function () {
  "use strict";
	...
	.controller("application.personalInfo.emergencyContactCtrl", function ($scope, $timeout, $location, $q, utilServ, appServ, applicationServ, relationshipServ, countryServ) {
		var self = this;
		...
		self.saveChange = {
			validate: function () {
				...
				if (!self.formField.name) { self.formValidate.isValid.name = false; i++; }
				if (!self.formField.relationshipSelected.selected) { self.formValidate.isValid.relationship = false; i++; }
				...
				if (!self.formField.homeTel) { self.formValidate.isValid.homeTel = false; i++; }
				if (!self.formField.mobile) { self.formValidate.isValid.mobile = false; i++; }
