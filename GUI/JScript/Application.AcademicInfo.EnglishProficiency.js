...
(function () {
    ...
    .controller("application.academicInfo.englishProficiencyCtrl", function ($scope, $timeout, $location, $q, utilServ, appServ, applicationServ, TOEFLTypeServ) {
        var self = this;
        ...
        self.setNotEnglish = function (e, value) {
            $timeout(function () {
                var isChecked;
        ...
        self.saveChange = {
            validate: function () {
                ...
                if (self.formField.notEnglishSelected === false && !self.formField.TOEFLScore && !self.formField.TOEFLTypeSelected.selected && !self.formField.IELTSResult && !self.formField.englishProficiencyOther)
                {
