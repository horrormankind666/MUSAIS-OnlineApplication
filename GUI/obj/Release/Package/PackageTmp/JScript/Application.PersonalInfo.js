...
(function () {
    ...
    .service("personalInfoServ", function ($timeout, utilServ, dictServ, pageRouteServ) {
        var self = this;
    ...
    .controller("application.personalInfoCtrl", function ($scope, $timeout, $q, utilServ, appServ, dictServ, pageRouteServ, personalInfoServ) {
        var self = this;
