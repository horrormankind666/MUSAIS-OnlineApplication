...
(function () {
	...
	.controller("application.personalInfo.mailingAddressCtrl", function ($scope, $timeout, $q, utilServ, appServ, dictServ, applicationServ, personalInfoServ, countryServ) {
		var self = this;
