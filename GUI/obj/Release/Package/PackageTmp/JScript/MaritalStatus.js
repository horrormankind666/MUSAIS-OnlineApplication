...
Description : <รวมรวบฟังก์ชั่นใช้งานสำหรับข้อมูลสถานภาพทางการสมรส>
=============================================
*/
...
(function () {
	...
	angular.module("maritalStatusMod", [
		"appMod"
	])

	.service("maritalStatusServ", function ($timeout, $q, appServ) {
		var self = this;
				...
				appServ.getListMaritalStatus({
					...
					for (var i = 0; i < result.length; i++) {
						...
						dt.push({
							id: (dr.id ? dr.id : ""),
							name: {
								TH: (dr.maritalStatusNameTH ? dr.maritalStatusNameTH : ""),
