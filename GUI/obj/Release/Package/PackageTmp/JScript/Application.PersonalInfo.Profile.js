...
(function () {
    ...
    .controller("application.personalInfo.profileCtrl", function ($scope, $timeout, $q, utilServ, appServ, applicationServ, personalInfoServ, titlePrefixServ, genderServ, nationalityServ, maritalStatusServ) {
        var self = this;
        ...
        self.saveChange = {
            validate: function () {
                ...
                if (!$scope.datepickerBirthDate.date) { self.formValidate.isValid.birthDate = false; i++; }
                ...
                if (!self.formField.maritalStatusSelected) { self.formValidate.isValid.maritalStatus = false; i++; }
                if (!self.formField.passportNumber) { self.formValidate.isValid.passportNumber = false; i++; }
                if (!$scope.datepickerPassportExpiryDate.date) { self.formValidate.isValid.passportExpiryDate = false; i++; }
